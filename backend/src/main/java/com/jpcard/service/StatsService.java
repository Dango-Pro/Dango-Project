    ...
    public DashboardExtendedResponse getExtendedStats(Long userId) {
        ...
        for (Deck deck : userDecks) {
            ...
            long newCards = progressRepository.countByUserIdAndCardDeckIdAndStatus(userId, deck.getId(),
                    StudyStatus.NEW);
            long learningCards = progressRepository.countByUserIdAndCardDeckIdAndStatus(userId, deck.getId(),
                    StudyStatus.LEARNING);
            long reviewCards = progressRepository.countByUserIdAndCardDeckIdAndStatus(userId, deck.getId(),
                    StudyStatus.REVIEW);
            long suspendedCards = progressRepository.countByUserIdAndCardDeckIdAndStatus(userId, deck.getId(),
        ...
        return new DashboardExtendedResponse(reviewsToday, accuracyPercent, streakDays, deckProgress, weeklyTrend);
    }
