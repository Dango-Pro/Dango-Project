        ...
        {user && (
          <div className="form-grid" style={{ marginTop: 12 }}>
            <div className="action-card">
              <p className="muted">{t('user.username')}</p>
                  ...
                  {editingTimezone ? (
                    <div style={{ display: 'flex', gap: 5 }}>
                      ...
                      <button
                        ...
                        onClick={() => {
                          setEditingTimezone(false);
                          setNewTimezone(user.timezone || 'UTC');
                        }}>
                        {t('common.cancel')}
                      </button>
                    </div>
                  ) : (
                    <button className="secondary-btn" style={{ padding: '6px 12px', fontSize: '0.8rem' }} onClick={() => setEditingTimezone(true)}>
                      {t('common.edit')}
                    </button>
                  )}
                </div>
