    ...
    <Layout pageTitle={t("auth.login_title")}>
      ...
      <section className="glass-card">
        <div className="card-header">
          <h2 className="card-title">{t("auth.login_title")}</h2>
          <button className="secondary-btn" onClick={() => setId("demo")}>{t("auth.quick_fill")}</button>
        </div>
        <div className="form-grid">
          ...
          <div style={{ marginTop: 30, paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.1)', textAlign: 'center' }}>
             <p className="muted" style={{ marginBottom: 10 }}>{t("auth.no_account")}</p>
