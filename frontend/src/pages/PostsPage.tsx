...
// 1. 사용자 정보 가져오기 (제하 님의 주석 및 구조 적용)
	useEffect(() => {
	...
	}, []); // 마운트 시 1회만 실행되어 불필요한 API 호출 방지

// 2. 게시글 목록 가져오기 (제하 님의 async/await 구조 + 팀의 로직)
	useEffect(() => {
		const loadPosts = async () => {
			// t 함수를 직접 호출하되, query가 바뀔 때만 실행되도록 의존성 관리
